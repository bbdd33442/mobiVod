...
import edu.csu.dlna.engine.MultiPointController;
import edu.csu.dlna.inter.IController;
...
//        urls.add("http://video19.ifeng.com/video06/2012/04/11/629da9ec-60d4-4814-a940-997e6487804a.mp4"); // 佟丽娅
        ...
        Log.d(TAG, "uri: " + uri);
//        urls.add(uri);
        urls.add("http://192.168.1.253/movie/sample.mp4"); //铁掌旋风腿
