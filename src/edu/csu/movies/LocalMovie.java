        ...
        button.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < totalCount; i++) {
                    String fileaddress = cursor.getString(cursor.getColumnIndex(MediaColumns.DATA));//·��
                    String adddate = cursor.getString(cursor.getColumnIndex(MediaColumns.DATE_ADDED));//���ʱ��
                    String lasttime = cursor.getString(cursor.getColumnIndex(VideoColumns.DURATION));//����ʱ��ʱ��
                ...
                cursor.close();
                help.close();
                Toast.makeText(LocalMovie.this, "ɨ�����", Toast.LENGTH_LONG).show();
